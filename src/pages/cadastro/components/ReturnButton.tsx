...
export function ReturnButton({ icon: Icon, children, ...props }: ReturnButtonProps) {
  return (
    <Button variant="ghost" className="group px-2" {...props}>
      <div className="w-6 h-6 rounded-full border-2 border-primary flex items-center justify-center shrink-0 group-hover:border-white transition-colors duration-200">
