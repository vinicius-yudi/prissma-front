...
/**
 * O `Intl` separa símbolo e número com espaço NÃO quebrável (U+00A0), que é
 * invisível no diff e faz a asserção falhar por um caractere que ninguém vê.
 * Normalizar aqui deixa o teste falar de conteúdo, não de bytes.
 */
